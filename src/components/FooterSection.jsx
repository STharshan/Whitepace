...
const FooterSection = () => {
  return (
    <footer className="bg-blue-900 text-white pt-20 pb-10 px-6 md:px-20">
      {/* Top CTA Section */}
      <div className="text-center mb-16">
        ...
        <div className="flex justify-center">
          <button className="bg-blue-500 hover:bg-blue-500 text-white px-6 py-2 mt-8 rounded-md flex items-center gap-2 transition">
      ...
      {/* Footer Grid */}
      <div className="grid md:grid-cols-5 gap-8 pt-10">
        ...
        <div>
          ...
          <button className="bg-blue-600 hover:bg-blue-500 text-white px-4 py-2 rounded-md flex items-center gap-2 transition">
      ...
      {/* Bottom Footer */}
     <div className="flex flex-col md:flex-row justify-between items-center mt-10 border-t border-gray-200 pt-6 text-sm text-gray-200">
  <div className="flex items-center gap-x-18 mb-4 md:mb-0 flex-wrap">
    {/* Grouped: Globe + English + Chevron (no gap) */}
    ...
    {/* These will have consistent spacing */}
