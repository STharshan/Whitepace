...
const DataSection = () => {
  return (
    <section className="py-16 px-20 bg-white text-gray-900">
      {/* Top Section */}
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row gap-10">
        {/* Left Text Content */}
        <div className="md:w-1/2 text-center md:text-left">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            100% <span className="text-black">your data</span>
          </h2>
          <p className="text-gray-700 mb-6 text-sm md:text-base w-135">
        ...
        <div className="md:w-1/2">
          <img
            ...
            className="w-full max-w-md mx-auto md:ml-10"
          />
        </div>
      </div>
