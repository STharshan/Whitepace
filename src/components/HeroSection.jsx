...
const HeroSection = () => {
  return (
    <div className="bg-blue-900 text-white h-90 flex flex-col items-center justify-center px-6">
      <div className="text-center max-w-3xl">
        <h1 className="text-2xl md:text-5xl font-bold mb-4">
          Your work, <span className="underline decoration-white">everywhere you are</span>
        </h1>
        ...
        <button className="bg-blue-400 hover:bg-blue-600 text-white px-6 py-2 rounded-md transition">
